...
class EntityProvider
{
    ...
    public static function getTVShowEntities($con, $categoryId, $limit)
    {
        ...
        $sql = "SELECT DISTINCT(entities.id) FROM entities INNER JOIN videos
                ON entities.id = videos.entityId WHERE videos.isMovie=0 ";
    ...
    public static function getMoviesEntities($con, $categoryId, $limit)
    {
        ...
        $sql = "SELECT DISTINCT(entities.id) FROM entities INNER JOIN videos
                ON entities.id = videos.entityId WHERE videos.isMovie=1 ";
